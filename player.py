...
class Player:
    def __init__(self, game):
        ...
        self.rel = 0
        self.health_recovery_time = 700
        self.time_prev = pg.time.get_ticks()
        # normalising the move vector
        self.diagonal_movement_corr = 1 / math.sqrt(2)
    ...
    def check_health_recovery_delay(self):
        ...
        if time_now - self.time_prev > self.health_recovery_time:
    ...
    def get_damage(self, damage):
        ...
        self.game.sound.player_pain.set_volume(1)
    ...
    def single_fire_event(self, event):
        if event.type == pg.MOUSEBUTTONDOWN:
            if event.button == 1 and not self.shot and not self.game.weapon.reloading:
                ...
                self.game.sound.shotgun.set_volume(1)
                self.shot = True
    ...
    def movement(self):
        ...
        if num_key_pressed:
            dx *= self.diagonal_movement_corr
            dy *= self.diagonal_movement_corr
